    ...
    if (url.pathname === "/api/youtube") {
      ...
      try {
        ...
        for (const video of videos) {
          ...
          //     worker's copy.
          //     The trailing team/score/team/score alternative catches the comma-or-space box score
          //     SCORE_RX's hyphenated form misses ("Grizzlies 110, Lakers 105", "Lakers 105 Grizzlies 110").
