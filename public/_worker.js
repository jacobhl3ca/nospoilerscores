    ...
    if (url.pathname === "/api/youtube") {
      ...
      try {
        ...
        for (const video of videos) {
          ...
          //     "(?:take|took) the chequered flag" and "cross(?:es|ed|ing) the (finish) line first" cover
          //     motorsport and other racing (F1/IndyCar/NASCAR/MotoGP, athletics/cycling/swimming) — a
          //     category the team-sport result verbs barely touch. Only the winner "takes" the flag, and
