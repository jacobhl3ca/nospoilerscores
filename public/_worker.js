    ...
    if (url.pathname === "/api/youtube") {
      ...
      try {
        ...
        for (const video of videos) {
          ...
          //     winning comfortably in a highlight title. The "[verb][- ]?past"
          //     clause — (?:eas(?:e|es|ed)|power(?:s|ed)?|breez(?:e|es|ed)|
          //     coast(?:s|ed)?|stroll(?:s|ed)?|waltz(?:es|ed)?)[- ]?past — adds the
          ...
          //     coast past Alaves"). It's anchored to the mandatory trailing "past"
          ...
          //     and "years past" never fire. Its one benign collision — "ease past
          //     the keeper" (a dribble) — reveals a goal not a result and errs
