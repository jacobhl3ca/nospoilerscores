...
const FAQ: { q: string; a: string; link?: { href: string; text: string } }[] = [
  ...
  },
  {
    ...
    a: "Yes. HideScore is a free app on the App Store for iPhone and iPad and on Google Play for Android, and it also works in any web browser at hidescore.com.",
  },
  {
