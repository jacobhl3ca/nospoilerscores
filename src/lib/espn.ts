...
const SPORT_GLYPH: Partial<Record<Sport, string>> = {
  ...
  nfl: "🏈", ncaaf: "🏈", cfl: "🏈", nhl: "🏒", ncaah: "🏒", golf: "⛳", tennis: "🎾",
...
const SPORT_GROUP: Partial<Record<Sport, SportGroup>> = {
  nfl: "us", nba: "us", mlb: "us", nhl: "us", ncaah: "us", cfl: "us", wnba: "us",
...
const PERIOD_SECONDS: Partial<Record<Sport, number>> = {
  ...
  nfl: 900, ncaaf: 900, cfl: 900, // 15-min quarters
...
const END_OF_PLAY_REGULATION: Partial<Record<Sport, number>> = {
  nfl: 4, ncaaf: 4, cfl: 4, nba: 4, wnba: 4, ncaaw: 4, ncaam: 2, nhl: 3, ncaah: 3,
};
...
export function fetchSportTeams(sport: Sport): Promise<SportTeam[]> {
  ...
  const url = WORKER_SCOREBOARD_SPORTS.has(sport)
    ...
    : `https://sports.core.api.espn.com/v3/sports${SPORT_PATHS[sport].replace(/\/scoreboard$/, "")}/teams?limit=400`;
    ...
    try {
      ...
      for (const t of items) {
        ...
        out.push({
          ...
          logo: t.logos?.[0]?.href || logoForTeam(sport, rawId, abbreviation),
        });
      }
