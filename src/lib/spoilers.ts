...
//     "(?:eas(?:e|es|ed)|power(?:s|ed)?|breez(?:e|es|ed)|coast(?:s|ed)?|stroll(?:s|ed)?|glid(?:e|es|ed)|
...
//     stroll/strolls/strolled, glide/glides/glided, waltz/waltzes/waltzed, roll/rolls/rolled); the rarer -ing forms are left alone like
...
//     possessive branch accepts both straight and curly apostrophes as real YouTube titles use. Its
//     benign over-matches ("spoil their party plans") err to the same over-hide-is-safe side as the
