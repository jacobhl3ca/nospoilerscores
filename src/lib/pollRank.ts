...
// Returns null for every sport but NCAAF, and for the two shapes ESPN uses to
// mean "not ranked": the sentinel 99, and an absent curatedRank.
//
// The 1-25 bound is deliberate rather than a bare `!== 99`. Both the AP Top 25
// and the CFP ranking stop at 25, so anything from 26 to 98 is a shape we have
