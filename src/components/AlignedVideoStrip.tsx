...
function CompactTailRow({ item, isFirst, onPlay }: { item: NewsItem; isFirst: boolean; onPlay?: PlayHandler }) {
  ...
  const rowCls = "flex flex-1 items-center gap-2 px-2.5 py-2 text-[11px] sm:text-[13px] leading-tight transition-colors hover:bg-[var(--bg-card-hover)] w-full text-left";
